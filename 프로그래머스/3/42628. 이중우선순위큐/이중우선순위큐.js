...
//         type === 'max' ? this.maxHeapifyUp() : this.minHeapifyUp();
//     }
...
//         type === 'max' ? this.maxHeapifyDown() : this.minHeapifyDown();
...
//         while (this.data[this.getLightChildIndex(currentIndex)] !== undefined) {
//             let bigIndex = this.getLightChildIndex(currentIndex);
            
//             if (this.data[this.getRightChildIndex(currentIndex)] !== undefined && this.data[this.getLightChildIndex(currentIndex)] < this.data[this.getRightChildIndex(currentIndex)])
//                 bigIndex = this.getRightChildIndex(currentIndex);
        
//             if (this.data[currentIndex] < this.data[bigIndex]){
...
//         while (this.data[this.getLightChildIndex(currentIndex)] !== undefined) {
//             let smallIndex = this.getLightChildIndex(currentIndex);
            
//             if (this.data[this.getRightChildIndex(currentIndex)] !== undefined && this.data[this.getLightChildIndex(currentIndex)] > this.data[this.getRightChildIndex(currentIndex)])
//                 smallIndex = this.getRightChildIndex(currentIndex);
        
//             if (this.data[currentIndex] < this.data[smallIndex]){
...
//         if (type === 'I') {
//             maxHeap.push('max', +value);
//             minHeap.push('min', +value);
//         } 
...
function solution(operations) {
    ...
    if (list.data.length < 2) {
        ...
        return [list.data[0], list.data[list.data.length - 1]];
    }
